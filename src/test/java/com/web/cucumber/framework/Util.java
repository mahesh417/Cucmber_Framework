...
public class Util {
	...
	static Logger utilLog = Logger.getLogger(Util.class);
	private Util() {
	...
	public static byte[] takeScreenshot(WebDriver driver) 
	{
		if (driver == null) 
		{
			Assert.assertTrue(false,"Report.driver is not initialized!");
		}
	...
	public static String takeScreenshotFile(WebDriver driver) {
		...
		try {
			...
			utilLog.info("Screenshot file was not saved with the exception: " + e);
		}
